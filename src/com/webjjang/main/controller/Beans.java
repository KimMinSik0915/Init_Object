...
public class Beans {
	...
	// 객체를 저장하는 변수 선언 및 생성 후 저장해 놓는다. : service객체를 저장한다.
	// Map<URL String, 실행할 서비스 객체>
	private static Map<String, Service> serviceMap = new HashMap<>();
	
	// Map<DAO 구분 String, 실행할 DAO객체>
	private static Map<String, Object> daoMap = new HashMap<>();
	
	// 저장을 위한 method : 서버가 실행되면서 객체 초기화 시킬 때 사용
	...
	// 실행할 객체 꺼내는 method : 사용자가 URL을 통해서 요청이 있으면 실행할 객체를 꺼낸다.
